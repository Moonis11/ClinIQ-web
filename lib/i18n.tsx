...
const translations = {
  ...
  visual_clinical_intelligence: { uz: "Klinik intellekt", ru: "Клинический интеллект", en: "Clinical intelligence" },
  visual_continuous_record: { uz: "Yagona tarix. Uzluksiz tibbiy yo'l.", ru: "Единая история. Непрерывный путь лечения.", en: "One continuous record. Every step of care." },
  visual_human_ai: { uz: "Shifokor nazoratidagi AI", ru: "ИИ под контролем врача", en: "Human-in-the-loop AI" },
  visual_oversight: { uz: "Klinik nazorat", ru: "Клинический контроль", en: "Clinical oversight" },
  visual_identity: { uz: "Shifrlangan identifikatsiya", ru: "Зашифрованная идентификация", en: "Encrypted identity" },
  visual_access: { uz: "Rolga asoslangan kirish", ru: "Ролевой доступ", en: "Role-based access" },
  visual_audit: { uz: "Audit izi", ru: "Журнал аудита", en: "Audit trail" },
  ...
  news_empty_title: { uz: "AI taklif qiladi. Shifokor tasdiqlaydi.", ru: "ИИ предлагает. Врач подтверждает.", en: "AI suggests. Clinicians decide." },
  news_empty_desc: {
    uz: "ClinIQ'da AI hech qachon yakuniy klinik qarorni mustaqil qabul qilmaydi. Har bir taklif shifokor nazoratida qoladi; muhim amallar audit jurnalida qayd etiladi, sezgir identifikatorlar esa shifrlanadi.",
    ru: "В ClinIQ ИИ никогда не принимает окончательное клиническое решение самостоятельно. Каждая рекомендация остаётся под контролем врача; важные действия фиксируются в журнале аудита, а чувствительные идентификаторы шифруются.",
    en: "ClinIQ never lets AI make the final clinical decision. Every suggestion remains clinician-controlled; critical actions are audit-logged and sensitive identifiers are encrypted.",
  },
  ...
  hero_title_1: { uz: "Har bir bemor uchun", ru: "Для каждого пациента", en: "One continuous record." },
  hero_title_2: { uz: "uzluksiz tibbiy yo'l.", ru: "единый путь лечения.", en: "Every step of care." },
  hero_subtitle: {
    uz: "ClinIQ bemorlar, shifokorlar va klinikalarni yagona xavfsiz tizimda bog'laydi — qabuldan laboratoriya, radiologiya, elektron retsept va kuzatuvgacha.",
    ru: "ClinIQ объединяет пациентов, врачей и клиники в одной защищённой системе — от записи до лаборатории, радиологии, электронного рецепта и наблюдения.",
    en: "ClinIQ connects patients, clinicians and clinics in one secure system — from booking to labs, radiology, e-prescriptions and follow-up.",
  },
  ...
  stat_clinics: { uz: "xususiy klinikali bozor", ru: "частных клиник на рынке", en: "private-clinic market" },
